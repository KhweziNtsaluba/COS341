...
public class ParseTable {
    ...
    ParseTable(){
        ...
        addAction(6, "end", new Action(ActionType.REDUCE, 47));
        addAction(6, "void", new Action(ActionType.SHIFT, 15));
        addAction(6, "$", new Action(ActionType.REDUCE, 47));
        ...
        addAction(11, "end", new Action(ActionType.REDUCE, 47));
        addAction(11, "void", new Action(ActionType.SHIFT, 15));
        addAction(11, "$", new Action(ActionType.REDUCE, 47));
        ...
        addGoto(13, "FNAME", 34);
        addAction(14, "F", new Action(ActionType.REDUCE, 51));
        addAction(15, "F", new Action(ActionType.REDUCE, 52));
        ...
        addGoto(27, "UNOP", 50);
        addGoto(27, "BINOP", 49);
        addAction(28, "(", new Action(ActionType.REDUCE, 46));
        ...
        addGoto(29, "VTYP", 3);
        addAction(30, "end", new Action(ActionType.REDUCE, 48));
        addAction(30, "$", new Action(ActionType.REDUCE, 48));
        addAction(31, "num", new Action(ActionType.REDUCE, 49));
        addAction(31, "end", new Action(ActionType.REDUCE, 49));
        addAction(31, "void", new Action(ActionType.REDUCE, 49));
        addAction(31, "$", new Action(ActionType.REDUCE, 49));
        addAction(32, "num", new Action(ActionType.SHIFT, 4));
        addAction(32, "text", new Action(ActionType.SHIFT, 5));
        addGoto(32, "VTYP", 63);
        addGoto(32, "LOCVARS", 62);
        addAction(33, "num", new Action(ActionType.REDUCE, 54));
        addAction(33, "text", new Action(ActionType.REDUCE, 54));
        ...
        addAction(38, ",", new Action(ActionType.REDUCE, 16));
        addAction(38, ";", new Action(ActionType.REDUCE, 16));
        addAction(38, ")", new Action(ActionType.REDUCE, 16));
        addAction(39, ",", new Action(ActionType.REDUCE, 17));
        addAction(39, ";", new Action(ActionType.REDUCE, 17));
        addAction(39, ")", new Action(ActionType.REDUCE, 17));
        addAction(40, ",", new Action(ActionType.REDUCE, 18));
        addAction(40, ";", new Action(ActionType.REDUCE, 18));
        addAction(40, ")", new Action(ActionType.REDUCE, 18));
        addAction(41, ",", new Action(ActionType.REDUCE, 19));
        addAction(41, ";", new Action(ActionType.REDUCE, 19));
        addAction(41, ")", new Action(ActionType.REDUCE, 19));
        addAction(42, ";", new Action(ActionType.REDUCE, 15));
        ...
        addAction(47, "then", new Action(ActionType.REDUCE, 31));
        addAction(48, "then", new Action(ActionType.REDUCE, 32));
        addAction(49, "(", new Action(ActionType.SHIFT, 75));
        addAction(50, "(", new Action(ActionType.SHIFT, 76));
        addAction(51, "(", new Action(ActionType.REDUCE, 38));
        addAction(52, "(", new Action(ActionType.REDUCE, 39));
        addAction(53, "(", new Action(ActionType.REDUCE, 40));
        addAction(54, "(", new Action(ActionType.REDUCE, 41));
        addAction(55, "(", new Action(ActionType.REDUCE, 42));
        addAction(56, "(", new Action(ActionType.REDUCE, 43));
        addAction(57, "(", new Action(ActionType.REDUCE, 44));
        addAction(58, "(", new Action(ActionType.REDUCE, 45));
        addAction(59, "(", new Action(ActionType.REDUCE, 36));
        addAction(60, "(", new Action(ActionType.REDUCE, 37));
        ...
        addAction(67, ";", new Action(ActionType.REDUCE, 21));
        addAction(68, ";", new Action(ActionType.REDUCE, 24));
        addAction(69, ";", new Action(ActionType.REDUCE, 25));
        addAction(70, ";", new Action(ActionType.REDUCE, 26));
        ...
        addAction(88, "end", new Action(ActionType.REDUCE, 47));
        addAction(88, "void", new Action(ActionType.SHIFT, 15));
        addAction(88, "$", new Action(ActionType.REDUCE, 47));
        addGoto(88, "FUNCTIONS", 103);
        addGoto(88, "DECL", 11);
        addGoto(88, "HEADER", 12);
        addGoto(88, "FTYP", 13);
        addGoto(88, "SUBFUNCS", 102);
        addAction(89, "num", new Action(ActionType.REDUCE, 55));
        addAction(89, "end", new Action(ActionType.REDUCE, 55));
        addAction(89, "void", new Action(ActionType.REDUCE, 55));
        addAction(89, "$", new Action(ActionType.REDUCE, 55));
        ...
        addAction(93, ")", new Action(ActionType.REDUCE, 29));
        addAction(94, ",", new Action(ActionType.REDUCE, 30));
        addAction(94, ")", new Action(ActionType.REDUCE, 30));
        ...
        addAction(109, ";", new Action(ActionType.REDUCE, 23));
        addAction(110, ")", new Action(ActionType.SHIFT, 117));
        addAction(111, ")", new Action(ActionType.SHIFT, 118));
        addAction(112, "num", new Action(ActionType.REDUCE, 53));
        addAction(112, "end", new Action(ActionType.REDUCE, 53));
        addAction(112, "void", new Action(ActionType.REDUCE, 53));
        addAction(112, "$", new Action(ActionType.REDUCE, 53));
        ...
        addAction(117, ",", new Action(ActionType.REDUCE, 33));
        addAction(117, ")", new Action(ActionType.REDUCE, 33));
        addAction(117, "then", new Action(ActionType.REDUCE, 33));
        addAction(118, "then", new Action(ActionType.REDUCE, 34));
        ...
        addAction(121, ",", new Action(ActionType.REDUCE, 28));
        addAction(121, ";", new Action(ActionType.REDUCE, 28));
        addAction(121, ")", new Action(ActionType.REDUCE, 28));
        addAction(122, ";", new Action(ActionType.REDUCE, 22));
        addAction(123, "V", new Action(ActionType.SHIFT, 9));
        addGoto(123, "VNAME", 125);
        addAction(124, "{", new Action(ActionType.REDUCE, 50));
        addAction(125, ",", new Action(ActionType.SHIFT, 126));
        addAction(126, "begin", new Action(ActionType.REDUCE, 56));
    }
